...
import { POST_BILL_PAYMENT_STATIC_API } from "~/apis/PostBillPaymentAPI";
...
const AdminPayTheBills = () => {
    ...
    const handleSearch = () => {
        if (!validateDate(day)) {
            ...
            setRows(searchByDate2(rows, day));
        }
    }
        ...
        <Box sx={{ mx: 20 }}>
            ...
            <Box sx={{mt: 5}}>
                ...
                <Box>
                    ...
                    />
                    <Button variant="outlined" sx={{mx: 5}} onClick={handleSearch}>Search</Button>
                </Box>
            </Box>
